 ...
 * <p>예전에는 요청이 오는 순간 SURGERY 행을 만들었다. 그러면 세 가지가 어긋난다.</p>
 * <ul>
 *   <li>반려된 요청도 수술 행으로 남아 "수술 건수"에 한 번도 수술이 아니었던 것이 섞인다</li>
 *   <li>진료가 반려 후 다시 요청하면 새 수술 행이 또 생기고, 앞 요청과 이어지지 않는다</li>
 *   <li>아직 수술실도 확정 시각도 없는 것을 '일정'이라 부르게 된다</li>
 * </ul>
 * <p>§21.7 의 판단 기준 중 <b>1번(부모 없이 자식이 존재 가능한가)</b>과 <b>4번(취소·재접수가
 * 가능한가)</b>에 걸린다 — 오더는 수술 없이 존재할 수 있고, 반려 후 재요청이 실제로 일어난다.
 * (2026-08-13 결정)</p>
 *
 * <h3>수락하면 어떻게 되는가</h3>
